    ...
    <>
      <div
        ...
        <div
          ...
          <h2
            className={cx(
              "text-brand-primary mt-2 line-clamp-2 text-xl font-semibold tracking-normal dark:text-[#f7f7f7]",
              featured ? "lg:text-3xl" : "lg:text-2xl"
            )}>
            <Link href={`/post/minimal/${post.slug.current}`}>
              <span
                className="bg-gradient-to-r from-[#1c1c1c] to-[#1c1c1c] bg-[length:0px_2px] bg-left-bottom
        bg-no-repeat
        transition-[background-size]
        duration-500
        hover:bg-[length:100%_2px]
        group-hover:bg-[length:100%_2px]
        dark:from-[#f7f7f7] dark:to-[#f7f7f7]">
                {post.title}
              </span>
            </Link>
          </h2>
